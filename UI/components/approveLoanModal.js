const approveLoanBtn = document.querySelector('#approve-loan-btn');
const approveLoanForm = document.querySelector('#approve-loan-modal-form');
const closeApproveLoanModal = document.querySelector('#close-approve-loan-modal');
